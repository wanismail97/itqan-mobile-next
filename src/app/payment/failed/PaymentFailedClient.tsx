...
// Shows when ToyyibPay redirects with failed/cancelled payment.
...
export default function PaymentFailedClient() {
  ...
  const handleWhatsApp = () => {
    const text = `Assalamualaikum.\nSaya cuba membuat pembayaran untuk pesanan ${orderId} tetapi gagal. Boleh saya dapatkan bantuan?`;
        ...
        <div className="max-w-lg mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 mb-2">
              Pembayaran anda tidak dapat diproses atau telah dibatalkan.
            </p>
            ...
            {orderId && (
              <div className="bg-white rounded-xl shadow-sm p-6 mt-6 mb-6">
                ...
                <p className="text-xs text-gray-400 mt-2">
                  Status pesanan: Menunggu Bayaran
                </p>
              </div>
            )}

            <p className="text-gray-500 mb-8">
              Jika anda masih ingin meneruskan pembayaran, sila cuba semula
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              ...
              <Link
                href="/cart"
                className="inline-flex items-center justify-center bg-white text-primary px-8 py-3 rounded-full font-semibold border-2 border-primary hover:bg-gray-50 transition"
              >
                Kembali ke Bakul
              </Link>
